...
var consolidate, dox, exec, fs, gfm, marked, mkdirp, path, spawn, watchr, _ref,
...
exports.Docker = (function() {
  ...
  Docker.prototype.parseOpts = function(opts) {
    ...
    if (opts.colorScheme != null) {
      return opts.colourScheme = opts.colorScheme;
    }
  };
  ...
  */
  ...
  Docker.prototype.renderMarkdownHtml = function(content, filename, cb) {
    var _ref1;
    if ((_ref1 = this._renderMarkdown) == null) {
      this._renderMarkdown = ((function() {
        switch (this.markdownEngine) {
          case "gfm":
            return require("github-flavored-markdown").parse;
          default:
            marked = require("marked");
