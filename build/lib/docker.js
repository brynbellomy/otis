...
exports.Docker = (function() {
  ...
  */
  ...
  Docker.prototype.parseOpts = function(opts) {
    ...
    switch (this.markdownEngine) {
      ...
      default:
        return this._renderMarkdown = function(data) {
          return data;
        };
    }
  };
  ...
  */
  ...
  Docker.prototype.finished = function(err) {
    if (err) {
  ...
  */
  ...
  Docker.prototype.writeFileIfDifferent = function(filename, fileContent, callback) {
    var outDir;
    outDir = path.dirname(filename);
